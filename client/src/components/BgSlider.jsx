...
const BgSlider = () => {
  ...
  return (
    <div className='pb-10 md:py-20 mx-2'>
        {/* title */}
        <h1 className='mb-12 sm:mb-20 text-center text-2xl md:text-3xl lg:text-4xl mt-4 mb-4 font-semibold bg-gradient-to-r from-gray-900 to-gray-400 bg-clip-text text-transparent p-2'>Remove Background With High <br /> Quality and Accuracy.</h1>
        <div className='relative w-full mt-16 max-w-2xl overflow-hidden m-auto rounded-xl'>
